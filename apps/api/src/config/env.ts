...
const envSchema = z.object({
  ...
  OWNER_BIRTHDATE_HASH_SECRET: z
    .string()
    .min(32)
    .default("dev-birthdate-secret-change-before-production"),
  ADMIN_BOOTSTRAP_USERNAME: z.string().min(1).default("admin"),
  ADMIN_BOOTSTRAP_PASSWORD: z.string().min(12).default("change-me-admin-password"),
