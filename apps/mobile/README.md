...
Agar laptop Anda bisa membuat (*compile*) aplikasi Bluetooth ini, Anda harus mendaftarkan Java dan Android SDK ke sistem Windows Anda.
...
4. Di kotak atas (*User variables*), klik **New**:
   - Variable name: `JAVA_HOME`
   - Variable value: *(Paste jalur folder jbr tadi)*
...
2. Kembali ke menu Environment Variables, buat **New** lagi di kotak atas:
   ...
   - Variable value: *(Paste jalur folder Sdk tadi)*
