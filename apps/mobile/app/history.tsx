...
import { listBacklogItems, type BacklogSyncStatus, type LocalBacklogItem } from '../src/storage/backlogItems';
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            BLE ack berarti node menerima atau mengantrekan pesan. Sync backend terjadi saat internet tersedia.
          </Text>
        </View>
        ...
        <View style={styles.filterRow}>
          ...
          >
            <Text style={[styles.filterTabText, filter === 'backlog' && styles.filterTabTextActive]}>
...
const BacklogCard = ({ item }: { item: LocalBacklogItem }) => (
  <View style={styles.reportCard}>
    ...
    <Text style={styles.detailValue}>Dedup {item.senderNodeId}:{item.seqId}</Text>
