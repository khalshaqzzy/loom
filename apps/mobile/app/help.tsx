      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <View style={styles.ctaBanner}>
          ...
          <Text style={styles.ctaDesc}>
            Buat laporan darurat secara langsung. Anda tetap bisa mengisinya meski belum terhubung ke node.
          </Text>
          <TouchableOpacity
            style={styles.ctaBtn}
            onPress={() => router.push('/')}
...
const styles = StyleSheet.create({
  ...
  stepNum: {
    width: 32, height: 32, borderRadius: 10, backgroundColor: COLORS.textPrimary,
