...
export default function PengaturanScreen() {
  ...
  const handleResetBle = () => {
    Alert.alert(
      "Reset Koneksi BLE",
      "Koneksi aktif akan diputus dan node harus divalidasi ulang.",
      [
    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>
          Status perangkat dan data lokal. Mobile tetap bisa dipakai offline setelah node
          tervalidasi.
        </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <InfoRow
              label="Mobile installation ID"
              value={deviceId}
              actionLabel="Salin"
              onAction={handleCopyDeviceId}
            />
            <View style={styles.cardDivider} />
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <ActionRow
              title="Reset Koneksi BLE"
              description="Memutus koneksi dan memerlukan validasi ulang."
